...
public class Form {
    ...
    public Form(Long id, PersonalDetails personalDetails, PresentAddress presentAddress,
			PermanentAddress permanentAddress, BankDetails bankDetails, ElectricityDetails electricityDetails,
			GasDetails gasDetails, CardType cardType, ProfessionalDetails professionalDetails,
			IllnessDetails illnessDetails, PhysicalDetails physicalDetails, GeneralDetails generalDetails,
			AdditionalDetails additionalDetails, OtherDetails otherDetails, List<Member> members) {
		super();
		this.id = id;
    ...
    public Form(Long id, PersonalDetails personalDetails, PresentAddress presentAddress, PermanentAddress permanentAddress,
                BankDetails bankDetails, ElectricityDetails electricityDetails, GasDetails gasDetails, CardType cardType,
                IllnessDetails illnessDetails, PhysicalDetails physicalDetails, GeneralDetails generalDetails,
                AdditionalDetails additionalDetails, OtherDetails otherDetails, List<Member> members) {
        this.id = id;
        this.personalDetails = personalDetails;
	...
	public String toString() {
		return "Form [id=" + id + ", personalDetails=" + personalDetails + ", presentAddress=" + presentAddress
				+ ", permanentAddress=" + permanentAddress + ", bankDetails=" + bankDetails + ", electricityDetails="
				+ electricityDetails + ", gasDetails=" + gasDetails + ", cardType=" + cardType
				+ ", professionalDetails=" + professionalDetails + ", illnessDetails=" + illnessDetails
				+ ", physicalDetails=" + physicalDetails + ", generalDetails=" + generalDetails + ", additionalDetails="
				+ additionalDetails + ", otherDetails=" + otherDetails + ", members=" + members + "]";
	}
}

...
public class OwnershipType {
    ...
    public OwnershipType(Long id, String name, String remarks, String status, String feedBy, LocalDate feedDate) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "OwnershipType [id=" + id + ", name=" + name + ", remarks=" + remarks + ", status=" + status

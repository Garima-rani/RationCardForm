...
function CategoryType({ setTableData, master, headers = [], data = [], role }) {
            ...
            <tr key={item.id}>
              ...
              {editId !== item.id ? (
                ...
                <>
                  <td>
                    <Input
                      placeholder={item.name || "Category Of States and UTs"}
          ...
          >
            <div className="bg-white max-h-[80vh] overflow-auto min-w-[400px] md:min-w-[60vw] md:min-h-[60vh] flex flex-col gap-5 bg-[whitesmoke] rounded-md p-4">
              ...
              <div className="grid grid-cols-[40%_60%]">
                <p className="font-bold">Category Of States and UTs</p>

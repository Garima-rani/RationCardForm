...
function OwnershipType({ setTableData, master, headers = [], data = [], role }) {
            ...
            <tr key={item.id}>
              ...
              {editId !== item.id ? (
                ...
                <>
                  <td>
                    <Input
                      placeholder={item.name || "PDS Application Ownership Type Name"}
          ...
          >
            <div className="bg-white max-h-[80vh] overflow-auto min-w-[400px] md:min-w-[60vw] md:min-h-[60vh] flex flex-col gap-5 bg-[whitesmoke] rounded-md p-4">
              ...
              <div className="grid grid-cols-[40%_60%]">
                <p className="font-bold">PDS Application Ownership Type Name</p>

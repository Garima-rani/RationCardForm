...
function AddNewProcurementType({ master, setOpen }) {
    ...
    return (
        ...
        >
            <div className="bg-[whitesmoke] w-full p-5 flex flex-col gap-10 rounded-md max-h-[80vh] overflow-auto">
                ...
                >
                    <Input
                        label="Procurement Type Name"
                        {...register("name", { required: "Procurement Type Name is required" })}
                    />
...
export default AddNewProcurementType;

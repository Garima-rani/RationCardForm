...
function AddNewCategoryType({ master, setOpen }) {
    ...
    const submitHandler = async (data) => {
        try {
            ...
            await axios.post(`http://localhost:8080/api/categories`, formObj);
            ...
            <div className="bg-[whitesmoke] w-full p-5 flex flex-col gap-10 rounded-md max-h-[80vh] overflow-auto">
                ...
                >
                    <Input
                        ...
                        {...register("name", { required: "Category Type Name is required" })}
                    />
...
export default AddNewCategoryType;

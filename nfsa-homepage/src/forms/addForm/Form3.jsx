...
function Form3({ methods, setLoading }) {
  const {
    register,
    formState: { errors },
      ...
      <section className="card h-fit">
        ...
        <div className=" grid md:grid-cols-2 gap-x-6 gap-y-4 ">
          ...
          <Input
            ...
            onChange = {e => handleImageChange(e, methods, "otherDetails.casteCategoryCertificate",setLoading)}
      ...
      <section className="card">
        ...
        <div className=" grid md:grid-cols-2  gap-x-6 gap-y-4 ">
          ...
          <Input
            ...
            required={watch("isPhysicallyAble")}
            disabled={!watch("isPhysicallyAble")}
            onChange = {e => handleImageChange(e, methods, "physicalDetails.certificate",setLoading)}
      ...
      <section className="card h-fit">
        ...
        <div className=" grid md:grid-cols-2 gap-x-6 gap-y-4 ">
          ...
          <Input
            ...
            disabled={!watch("isCritical")}
            required={!watch("isCritical")}
            onChange = {e => handleImageChange(e, methods, "illnessDetails.certificate",setLoading)}

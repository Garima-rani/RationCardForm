...
function Form5({ methods ,setLoading }) {
  const {
    register,
    formState: { errors },
    watch,
              ...
              <tr>
                ...
                <td>
                  ...
                  <Input
                    ...
                    onChange = {(e) =>handleImageChange(e,methods , "identity.file" , setLoading)}
              ...
              <tr>
                ...
                <td>
                  ...
                  <Input
                    ...
                    onChange = {(e) =>handleImageChange(e,methods , "address.file" , setLoading)}
